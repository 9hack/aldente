...
namespace Constructs {
    const static std::map<ConstructType, ConstructData> CONSTRUCTS = {
        ...
        { ConstructType::SLIME_B,    { ConstructType::SLIME_B,      10, "Blue Slime",   "A bit gooey, and not the good kind.",     "slime_icon.png" } }, // change flavour here
        ...
        { ConstructType::CONFUSE,    { ConstructType::CONFUSE,      10, "Confuse",      "Makes you forget how your legs work.",   "spiral.png" } },
