#include "basic_anim_shader.h"
#include "shader_manager.h"
#include "shadow_shader.h"
#include "util/util.h"

BasicAnimShader::BasicAnimShader(GLuint shader_id) : Shader(shader_id) {}

void BasicAnimShader::set_material(Material *m) {
...
void BasicAnimShader::draw(Geometry *g, glm::mat4 to_world) {
    ...
    for (unsigned int i = 0; i < bones.size(); i++) {
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader_id, Name), 1, GL_FALSE, &bones[i][0][0]);
    }
