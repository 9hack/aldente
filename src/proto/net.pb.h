...
const Phase Phase_MAX = MINIGAME_RESULTS;
...
class ClientMessage : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_player_finished_dialogue() const;
  inline void clear_player_finished_dialogue();
  static const int kPlayerFinishedDialogueFieldNumber = 10;
  inline ::google::protobuf::int32 player_finished_dialogue() const;
  inline void set_player_finished_dialogue(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_player_finished_dialogue();
...
// optional int32 player_finished_dialogue = 10;
inline bool ClientMessage::has_player_finished_dialogue() const {
  return message_type_case() == kPlayerFinishedDialogue;
}
inline void ClientMessage::set_has_player_finished_dialogue() {
  _oneof_case_[0] = kPlayerFinishedDialogue;
}
inline void ClientMessage::clear_player_finished_dialogue() {
  if (has_player_finished_dialogue()) {
    message_type_.player_finished_dialogue_ = 0;
    clear_has_message_type();
  }
}
inline ::google::protobuf::int32 ClientMessage::player_finished_dialogue() const {
  if (has_player_finished_dialogue()) {
    return message_type_.player_finished_dialogue_;
  }
  return 0;
}
inline void ClientMessage::set_player_finished_dialogue(::google::protobuf::int32 value) {
  if (!has_player_finished_dialogue()) {
    clear_message_type();
    set_has_player_finished_dialogue();
  }
  message_type_.player_finished_dialogue_ = value;
}
